...
load('E:\Data\Using\Sound_IRP.mat')
load('D:\MyProjects\Matlab-Code\MATLAB\small_channal_Index.mat')
...
for sub_index = 1:7
    ...
    epoch_sum = epoch_sum + Sound_IRP{sub_index,1};
    epoch_sum2 = epoch_sum2 + Sound_IRP{sub_index,2};
end
...
%     rx2 = resample(rx2,125,250);
    rx2 = smooth(rx2);
    plot(xl,rx - rx2,'color','r','LineWidth',1.5);
